...
export default class Enemy3 extends Enemy1V1 {
	...
	constructor(scene: Phaser.Scene, plugin: SpinePlugin, x: number, y: number, dataKey?: string, atlasKey?: string, skin?: string, boundsProvider?: SpineGameObjectBoundsProvider, xargs?: any) {
		super(scene, plugin, x ?? 0, y ?? 0, dataKey ?? "Enemy3", atlasKey ?? "Enemy3-atlas", boundsProvider ?? new SkinsAndAnimationBoundsProvider(null, ["default"]));
